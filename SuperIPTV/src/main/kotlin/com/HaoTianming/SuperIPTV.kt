...
open class PublicIPTV : MainAPI() {
    override var lang = "en"
    override var mainUrl: String = BuildConfig.iptv-org
    override var name = "iptv-org IPTV"
    ...
    override spend fun search(query: String): List<SearchResponse> {
        val data = IptvPlaylistParser().parseM3U(app.get(mainUrl).text)
    ...
    override spend fun load(url: String): LoadResponse {
