...
class PublicConflictZoneIPTV1 : PublicIPTV() {
    override var lang = "universal"
    override var mainUrl: String = BuildConfig.public_conflict_zone_iptv_1
    override var name = "Public Conflict Zone IPTV #1"
